...
public class MainActivity extends AppCompatActivity {
    ...
    private final static  int  PERMISSIONS_REQUEST_SEND_SMS_ID = 15;
...
;
            ...
            Toast.makeText(this,
                    "SMS Message has successfully sent",
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if(requestCode == PERMISSIONS_REQUEST_SEND_SMS_ID) {
            ...
            {
                Toast.makeText(this, "SMS Permission Denied. Cannot Send Message", Toast.LENGTH_LONG).show();
            }
        }
    }
}